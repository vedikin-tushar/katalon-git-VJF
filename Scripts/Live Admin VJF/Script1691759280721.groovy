...
import com.sun.rowset.internal.WebRowSetXmlReader as WebRowSetXmlReader
...
WebUI.verifyElementText(findTestObject('For Admin/Page_VrajFresh Admin/span_36.30'), '$ 11.29', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/For Admin/Page_VrajFresh Admin/span_36.30'))

WebUI.verifyElementText(findTestObject('For Admin/Page_VrajFresh Admin/label_36.30'), '$ 11.29')
...
WebUI.verifyElementText(findTestObject('For Admin/Page_VrajFresh Admin/span_33.29'), '8.29')

WebUI.click(findTestObject('Object Repository/For Admin/Page_VrajFresh Admin/span_33.29'))

WebUI.verifyElementText(findTestObject('For Admin/Page_VrajFresh Admin/label_33.29'), '$ 8.29')
...
WebUI.setText(findTestObject('Object Repository/For add new one/Page_VrajFresh Admin/input_Sa_select2-search__field'), 'parle - s - 3.00 gms')
...
WebUI.verifyElementText(findTestObject('For Admin/Page_VrajFresh Admin/span_38.29'), '13.29')

WebUI.click(findTestObject('Object Repository/For Admin/Page_VrajFresh Admin/span_38.29'))

WebUI.verifyElementText(findTestObject('For Admin/Page_VrajFresh Admin/label_38.29'), '$ 13.29')
